...
/**
 * PlanetField — a flowing liquid-light ribbon (WebGL): an undulating luminous
 * band with glowing edges that morphs across the hero, matching the reference
 * recording. `variant='teal'` mirrors the recording; `'warm'` fits the Supernova
 * theme. Reduced-motion renders a single static frame.
 */
